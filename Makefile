#############################################################################
# Makefile for building: AS_forms
# Generated by qmake (2.01a) (Qt 4.8.1) on: ?? 19. ??? 00:03:18 2012
# Project:  AS_forms.pro
# Template: app
# Command: c:\qtsdk\desktop\qt\4.8.1\mingw\bin\qmake.exe -spec c:\QtSDK\Desktop\Qt\4.8.1\mingw\mkspecs\win32-g++ CONFIG+=declarative_debug -o Makefile AS_forms.pro
#############################################################################
...
Makefile: AS_forms.pro  c:/QtSDK/Desktop/Qt/4.8.1/mingw/mkspecs/win32-g++/qmake.conf c:/QtSDK/Desktop/Qt/4.8.1/mingw/mkspecs/qconfig.pri \
	...
	$(QMAKE) -spec c:\QtSDK\Desktop\Qt\4.8.1\mingw\mkspecs\win32-g++ CONFIG+=declarative_debug -o Makefile AS_forms.pro
